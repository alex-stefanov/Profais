        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedForId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectsRequests_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPenalties", x => new { x.UserId, x.PenaltyId });
                    table.ForeignKey(
                        name: "FK_UsersPenalties_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UsersPenalties_Penalties_PenaltyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfProjectRequestId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProfProjectRequestId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_Projects_ProfProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TasksMaterials", x => new { x.MaterialId, x.TaskId });
                    table.ForeignKey(
                        name: "FK_TasksMaterials_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_TasksMaterials_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersTasks", x => new { x.WorkerId, x.TaskId, x.VehicleId });
                    table.ForeignKey(
                        name: "FK_UsersTasks_AspNetUsers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ProfProjectRequestId",
                table: "Projects",
                column: "ProfProjectRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectsRequests_ClientId",
                table: "ProjectsRequests",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_ProfProjectId",
                table: "Tasks",
                column: "ProfProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TasksMaterials_TaskId",
                table: "TasksMaterials",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersPenalties_PenaltyId",
                table: "UsersPenalties",
                column: "PenaltyId");
